...
Examples (doctests):
    ...
    >>> h = '<h1>abc</h1>'
    >>> hindawi2md.markdownify(h, md_style=UNDERLINED)
    '\\n\\nabc\\n===\\n\\n'

    >>> h = '<h1>abc</h1>'
    >>> hindawi2md.markdownify(h, md_style=ATX)
    '\\n\\n# abc\\n\\n'
